    ...
    <ContentSectionContainer id="landing-container" flexDirection="RTL" containerClassNames="items-center">
      <GenericContentContainer id="landing-intro" padding="None" containerClassNames="w-full md:w-9/12 md:-mt-3 lg:-mt-16">
        <ContentSectionHeader childrenAlignment="Left">
            ...
            <p className="mt-8 body-text">At <span className="font-semibold">HAUS</span>, our approach with clients is to help them with their list of projects, big or small. With over 30 years in high tech, at some of the largest companies in the United States, respectful and considerate communication and collaboration were the foundations of success then -- and they continue to be the foundation of HAUS' success today on any project.</p>
