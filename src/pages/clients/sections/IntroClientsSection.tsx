            ...
            <div className="mx-auto px-4 md:px-6 xl:max-w-6xl xl:px-0">
                <div className="relative w-auto flex flex-col">
                    <div className="py-2 px-0 md:p-2 w-auto text-center">
                        ...
                        <h1 className="relative text-center text-4xl font-bold text-gray-900 dark:text-white sm:text-5xl md:text-6xl">Job #1 &rsaquo; <span className="opacity-80">Helping Clients</span></h1>
