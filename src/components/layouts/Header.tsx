...
const Header = () => {
  ...
  return (
    <header>
      <nav id="navbar" className={`fixed inset-x-0 z-40 w-full border-b border-gray-100 bg-white/80 backdrop-blur dark:border-gray-700/30 dark:bg-gray-900/80 ${isNavbarActive ? "navbar-active" : ""}`}>
